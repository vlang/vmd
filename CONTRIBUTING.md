...
1. Fork https://github.com/vlang/vmd using GitHub's interface to your own account.
   Let's say that the forked repository is at
   `https://github.com/YOUR_GITHUB_USERNAME/vmd` .
2. Clone the main vmd repository https://github.com/vlang/vmd to a local folder on
   your computer, say named vmd/ (`git clone https://github.com/vlang/vmd vmd`)
3. `cd vmd`
4. `git remote add pullrequest https://github.com/YOUR_GITHUB_USERNAME/vmd`
   NB: the remote named `pullrequest` should point to YOUR own forked repo, not the
   main vmd repository! After this, your local cloned repository is prepared for
...
7. On GitHub's web interface, go to: https://github.com/vlang/vmd/pulls
...
9. If there are merge conflicts, or a branch lags too much behind vmd's master,
